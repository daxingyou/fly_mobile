        ...
        <div class="container">
            ...
            <yd-cell-item  href="#" type="link">
              ...
              <yd-cell-item  href="#" type="link">
                ...
                <span slot="right">{{$route.query.status==='2'?'离线':"在线"}}</span>
            </yd-cell-item>
        </div>
        <div class="footer" v-show="$route.query.account!==userDetails.account">
            <Box v-if="show3" @click.native="query(account,'1','1',UserByAccount.nickName,$route.query.status)" width="3.5rem" height=".8rem" backgroundColor="#d91d36" colorEffect="#a52c3c">
                <span>发消息</span>
            </Box>
