  ...
  <div class="register">
    ...
    <div class="register_nav">
      ...
      <div style="display: flex;position: relative;">
        <span>密码</span>
        <input :type="pwdType?'password':'text'" v-model="Password" id="passI">
        <i :class="pwdType?'hide':'show'" @click="setPwdType"></i>
      </div>
      <div style="display: flex;position: relative;">
        <span>确认密码</span>
        <input :type="pwdType2?'password':'text'" v-model="pass_word" id="passII">
        <i :class="pwdType2?'hide':'show'" @click="setPwdType2"></i>
      </div>
       <div>
        <span>邀请码</span>
        <input type="number" v-model="zc_code">
        <!-- <img src="" alt=""> -->
      </div> 
      <div>
				<span>验证码</span>
