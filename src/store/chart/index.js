...
export default {
  ...
  getters: {
    ...
    dealRecordAll(state){
      ...
      for(let i=0;i<state.allRecord.length;i++){
        for(let j=i+1;j<state.allRecord.length;j++){
    ...
    dealApplyRecord(state){
      for(let i=0;i<state.applyRecord.length;i++){
        for(let j=i+1;j<state.applyRecord.length;j++){
  ...
  actions: {
    ...
    queryFriendGroup({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('get', 'queryFriendGroup',params).then((res) => {
    ...
    saveFriendGroup({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('post', 'saveFriendGroup',params).then((res) => {
          resolve(res)
        })
      })
    },
    ...
    searchFriendGroupByFriendAccount({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('post', 'searchFriendGroupByFriendAccount',params).then((res) => {
          resolve(res)
        })
      })
    },
    ...
    delFriendGroup({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('post', 'delFriendGroup',params).then((res) => {
          resolve(res)
        })
      })
    },
    ...
    queryFriend({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('post', 'queryFriend',params).then((res) => {
    ...
    addFriendToFriendeGroup({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('post', 'addFriendToFriendeGroup',params).then((res) => {
          resolve(res)
        })
      })
    },
    ...
    sendRedPacket({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('post', 'sendRedPacket', params).then((res) => {
          resolve(res)
        })
      })
    },
    grabRedPacket({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('get', 'grabRedPacket', params).then((res) => {
          resolve(res)
        })
      })
    },
    sendGroupPacket({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('post', 'sendGroupPacket', params).then((res) => {
          resolve(res)
        })
      })
    },
    redPacketInfo({
      ...
      return new Promise(function (resolve, reject) {
        let res = request('get', 'redPacketInfo', params).then((res) => {
          resolve(res)
        })
      })
    },
