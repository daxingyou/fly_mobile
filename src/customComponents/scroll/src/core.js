(function(window) {
	...
	var Scroller = function(callback, options) {
		...
		setTimeout(function() {
			if(this.__container && this.__content) {
	...
	var members = {
		...
		*/
		...
		__indicatorX: null,
		__indicatorY: null,
		__transformProperty: transformProperty,
		__transformOriginProperty: transformOriginProperty,
			...
			if(self.__isDragging) {
				...
				if(self.__isSingleTouch && self.options.animating && (timeStamp - self.__lastTouchMove) <= 100) {
					...
					if(startPos !== endPos) {
						...
						var minVelocityToStartDeceleration = self.options.paging || self.options.snapping ? 4 : 4;
		...
		*/
		...
		__computeScrollMax: function(zoomLevel) {
			...
			console.log(self.__contentWidth,self.__clientWidth,zoomLevel)
